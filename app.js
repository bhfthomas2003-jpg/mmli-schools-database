    ...
    document.getElementById("lock-toggle").addEventListener("change", (e) => {
      if (e.target.checked) {
        openModal(`
          ...
          <p>This only hides the app behind a simple prompt on this device. It is <strong>not</strong> real security and can be bypassed by anyone with browser access.</p>
