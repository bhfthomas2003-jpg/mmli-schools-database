...
├── manifest.json           → Lets you "install" the site like an app
├── service-worker.js        → Enables offline use after first load
├── README.md                → This file
└── assets/
    └── mmli-logo.png          → MMLI logo used in the header and app icon
```
...
- **Logo doesn't show:** double-check the file was uploaded to
  `assets/mmli-logo.png` (exact path and name matter).
